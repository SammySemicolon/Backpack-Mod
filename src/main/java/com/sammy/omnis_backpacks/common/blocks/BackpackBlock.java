...
public class BackpackBlock extends HorizontalBlock
{
    ...
    public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity player, boolean willHarvest, FluidState fluid)
    {
        ...
        if (tileEntity instanceof BackpackTileEntity)
        {
            ...
            {
                world.addEntity(new ItemEntity(world, pos.getX() + 0.5f, pos.getY() + 0.5f, pos.getZ() + 0.5f, backpackTileEntity.backpack));
            }
        }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit)
    {
        ...
        if (tileEntity instanceof BackpackTileEntity)
        {
            ...
            if (backpackTileEntity.backpack != null)
            {
                AbstractBackpackItem backpackItem = (AbstractBackpackItem) backpackTileEntity.backpack.getItem();
                backpackItem.openContainer(worldIn, player, backpackTileEntity.backpack);
                worldIn.playSound(player, pos, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, SoundCategory.PLAYERS, 1, 1);
