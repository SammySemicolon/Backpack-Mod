...
import static com.sammy.omnis_backpacks.BackpackModHelper.*;
...
public class ModBlockStateProvider extends net.minecraftforge.client.model.generators.BlockStateProvider
{
    ...
    {
        super(gen, BackpackMod.MODID, exFileHelper);
    }
    ...
    public void backpackBlock(RegistryObject<Block> blockRegistryObject)
    {
        ...
        ModelFile backpack = models().withExistingParent(name, prefix("block/backpack")).texture("nocolor", "block/" +name);
